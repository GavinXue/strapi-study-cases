...
class TypegenPrinter {
    ...
    printHeadersGlobal() {
        ...
        if (this.typegenInfo.globalsPath) {
            headers.unshift(`import type { NexusGenTypes } from '${utils_1.relativePathTo(this.typegenInfo.typegenPath, (_a = this.typegenInfo.globalsPath) !== null && _a !== void 0 ? _a : '')}'`);
    ...
    printDynamicImport(forGlobal = false) {
        ...
        if (!forGlobal) {
            ...
            utils_1.eachObj(sourceTypings, (rootType, typeName) => {
