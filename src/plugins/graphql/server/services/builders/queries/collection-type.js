...
module.exports = ({ strapi }) => {
  ...
  const addFindOneQuery = (t, contentType) => {
    ...
    // fd changes: comment and change to typeName
    // const responseTypeName = getEntityResponseName(contentType);
    const {getEntityName} = naming
    const typeName = getEntityName(contentType)
    ...
    t.field(findOneQueryName, {
      ...
      async resolve(parent, args) {
        ...
        // fd changes: return value directly, no need entityResponse
        return value
